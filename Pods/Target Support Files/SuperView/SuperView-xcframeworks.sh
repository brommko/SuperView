...
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewCore.xcframework" "SuperView/Core" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewOneSignal.xcframework" "SuperView/OneSignal" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/OneSignal.xcframework" "SuperView/OneSignal" "framework" "ios-arm64_armv7_armv7s" "ios-arm64_i386_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
