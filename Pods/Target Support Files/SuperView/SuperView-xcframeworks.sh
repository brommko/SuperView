...
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewAdMob.xcframework" "SuperViewAdMob" "framework" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewCore.xcframework" "SuperViewCore" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewFirebase.xcframework" "SuperViewFirebase" "framework" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewLocation.xcframework" "SuperViewLocation" "framework" "ios-x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewOneSignal.xcframework" "SuperViewOneSignal" "framework" "ios-arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/OneSignal.xcframework" "OneSignal" "framework" "ios-arm64_armv7_armv7s" "ios-arm64_i386_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/SuperView/Frameworks/SuperViewQR.xcframework" "SuperViewQR" "framework" "ios-arm64" "ios-x86_64-simulator"
