...
+ (void)configureAdMob SWIFT_AVAILABILITY(ios,introduced=13);
@end
...
@interface SuperWebViewController (SWIFT_EXTENSION(SuperViewAdMob)) <GADRewardedAdDelegate>
...
@interface SuperWebViewController (SWIFT_EXTENSION(SuperViewAdMob)) <GADInterstitialDelegate>
